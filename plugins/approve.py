...
CONFIG = {
    ...
    "main_channel_url": "",
    "ott_updates_channel_url": "",
    "photo_url": "",  # Replace with your actual image URL
...
async def accept_request(client, r):
    ...
    try:
        ...
        rm = InlineKeyboardMarkup([
            ...
            [
                InlineKeyboardButton('OTT Updates', url=CONFIG[""]),
                InlineKeyboardButton('Main Channel', url=CONFIG[""]),
            InlineKeyboardButton('ʀᴇᴘᴏ', url='')
            ]
        ])
